...
get_menu_red() {
    ...
    echo -e "\n\tHERRAMIENTAS"
    echo -e "\t81. Wake On Lan Gtk (gwakeonlan)"
...
get_menu_internet() {
    ...
    echo -e "\n\tNAVEGADOR WEB"
    echo -e "\t1. Navegador Chromium (chromium-browser)"
...
get_menu_utilitarios() {
    ...
    echo -e "\t2. Alarma con alarm-clock (alarm-clock-applet)"
...
get_procesar_menu_utilitarios() {
	...
	do
		...
		case $opcion in
            ...
            2)
	            exec_instalar_alarm_clock_applet ;;            	
...
exec_instalar_gwakeonlan() {
    ...
    #fo:    00:27:0e:05:4d:ae
    #me:    00:30:67:53:8e:02
}
...
exec_instalar_chromium() {
    echo -e "------------------1.- Instalar Navegador Chromium (chromium-browser)----------------------"
